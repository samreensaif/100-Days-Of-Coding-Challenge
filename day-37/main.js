...
\n +++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n`));
let currentDay = new Date(); // get current date from system
let currentHour = currentDay.getHours(); // get hours from current date
let currentMin = currentDay.getMinutes(); // get minutes from current date
