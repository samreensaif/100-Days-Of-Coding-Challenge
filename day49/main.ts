...
let randomNumbers: number [] = [ 5,7,2,3,9,8,11,1,0,6]

// here arrow function works as a callback

let smallerNum: number[] = randomNumbers.filter((element ) =>  element <= 5 )  

console.log(smallerNum)

let mapNum: string[] = randomNumbers.map((element) => (`${element}00`))
