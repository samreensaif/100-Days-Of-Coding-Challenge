...
function firstOccurence(str) {
    var positionOfCode = str.indexOf("code");
    return positionOfCode;
}
var i = firstOccurence("this is my first code of typescript");
...
function wordPresent(str) {
    var ispresent = str.includes("Javascript");
    return ispresent;
}
...
var str = " Indeed!!! Pakistan is one of the beautiful country in the world";
